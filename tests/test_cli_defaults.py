...
from speech_to_speech.arguments_classes.parakeet_onnx_arguments import ParakeetOnnxSTTHandlerArguments
...
def test_parse_arguments_default_backend_returns_openai_api():
    ...
    assert args.vad_handler_kwargs.speculative_reopen_ms == 1000
