...
class ModuleArguments:
    ...
    tts: Optional[Literal["chatTTS", "facebookMMS", "pocket", "kokoro", "qwen3", "chatterbox"]] = field(
        default="qwen3",
        metadata={
            "help": "The TTS to use. Either 'chatTTS', 'facebookMMS', 'pocket', 'kokoro', 'qwen3', or 'chatterbox' (voice cloning). Default is 'qwen3'."
        },
    )
    log_level: str = field(
        default="info",
